...
/*Dado um vetor que guarda o valor de faturamento diário 
de uma distribuidora, faça um programa, 
...
IMPORTANTE:
a) Usar o json ou xml disponível como fonte dos
 dados do faturamento mensal;
b) Podem existir dias sem faturamento, como nos finais 
de semana e feriados. Estes dias devem ser ignorados 
no cálculo da média;*/
...
public class Exercicio3 {
    ...
    public static void main(String[] args) {
        ...
        JSONArray faturamentoArray = new JSONArray(jsonFaturamento);
